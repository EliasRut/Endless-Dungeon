...
export const generateColorReplacedTextures = (
	...
	textures.addCanvas('body-temp', replaceColors(
	...
	textures.addCanvas('hair-temp', replaceColors(
	...
	textures.addCanvas('shirt-temp', replaceColors(
	...
	textures.addCanvas('pants-temp', replaceColors(
...
export const getColorReplacedImageSource = (
		textures: Phaser.Textures.TextureManager
	) => {
		...
		const canvasTexture =
			textures.createCanvas('npc-canvas', CHARACTER_SPRITE_WIDTH, CHARACTER_SPRITE_HEIGHT);
		const canvas = canvasTexture.getSourceImage() as HTMLCanvasElement;
		const context = canvas.getContext('2d')!;

...
import { BAG_BOXES_X, BAG_BOXES_Y, EquipmentSlot } from '../helpers/constants';
...
export interface EquippedItems {
	[EquipmentSlot.SOURCE]: keyof Source | undefined;
	[EquipmentSlot.CATALYST]: keyof Catalyst | undefined;
	[EquipmentSlot.CHESTPIECE]: keyof ChestPiece | undefined;
	[EquipmentSlot.AMULET]: keyof Amulet | undefined;
	[EquipmentSlot.RIGHT_RING]: keyof Ring | undefined;
	[EquipmentSlot.LEFT_RING]: keyof Ring | undefined;
}

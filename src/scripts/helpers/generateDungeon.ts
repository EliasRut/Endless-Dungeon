...
const CAP_NORTH = [
	[IC_TL, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, IC_TR],
	[B_LFT, W_LTE, W_MTD, W_MTE, W_MTE, W_MTD, W_RTE, B_RGT],
	[B_LFT, W_LBE, W_MBD, W_MBE, W_MBE, W_MBD, W_RBE, B_RGT],
	[B_LFT, EMPTY, DCR_M, EMPTY, EMPTY, DCR_M, EMPTY, B_RGT],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
];
const CAP_SOUTH = [
	...
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[IC_BL, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, IC_BR],
];
const CAP_EAST = [
	[B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, IC_TR],
	[W_LTE, W_MTD, W_MTE, W_MTE, W_MTD, W_MTE, W_RTE, B_RGT],
	[W_MBE, W_MBD, W_MBE, W_MBE, W_MBD, W_MBE, W_RBE, B_RGT],
	[EMPTY, DCR_M, EMPTY, EMPTY, DCR_M, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, IC_BR],
];
const CAP_WEST = [
	[IC_TL, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP],
	[B_LFT, W_LTE, W_MTE, W_MTD, W_MTE, W_MTE, W_MTD, W_MTE],
	[B_LFT, W_LBE, W_MBE, W_MBD, W_MBE, W_MBE, W_MBD, W_MBE],
	[B_LFT, EMPTY, EMPTY, DCR_M, EMPTY, EMPTY, DCR_M, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[IC_BL, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT],
];
const CORRIDOR_UP = [
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
...
const CORRIDOR_LEFT = [
	[B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP],
	[W_MTE, W_MTE, W_MTD, W_MTE, W_MTE, W_MTD, W_MTE, W_MTE],
	[W_MBE, W_MBE, W_MBD, W_MBE, W_MBE, W_MBD, W_MBE, W_MBE],
	[EMPTY, EMPTY, DCR_M, EMPTY, EMPTY, DCR_M, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT, B_BOT],
];
const CORRIDOR_UP_RIGHT = [
	[IC_TL, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP],
	[B_LFT, W_LTE, W_MTD, W_MTE, W_MTE, W_MTD, W_MTE, W_MTE],
	[B_LFT, W_LBE, W_MBD, W_MBE, W_MBE, W_MBD, W_MBE, W_MBE],
	[B_LFT, EMPTY, DCR_M, EMPTY, EMPTY, DCR_M, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, OC_BR],
];
const CORRIDOR_UP_LEFT = [
	[B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, IC_TR],
	[W_MTE, W_MTD, W_MTE, W_MTE, W_MTD, W_MTE, W_RTE, B_RGT],
	[W_MBE, W_MBD, W_MBE, W_MBE, W_MBD, W_MBE, W_RBE, B_RGT],
	[EMPTY, DCR_M, EMPTY, EMPTY, DCR_M, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[OC_BL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
];
const CORRIDOR_DOWN_RIGHT = [
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, OC_TR],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, W_LTE],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, W_LBE],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
...
const CORRIDOR_DOWN_LEFT = [
	[OC_TL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[W_RTE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[W_RBE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
...
const T_CROSSING_TOP_LEFT_RIGHT = [
	[OC_TL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, OC_TR],
	[W_RTE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, W_LTE],
	[W_RBE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, W_LBE],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
...
const T_CROSSING_LEFT_RIGHT_BOTTOM = [
	...
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[OC_BL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, OC_BR],
];
const CROSSWAY = [
	[OC_TL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, OC_TR],
	[W_RTE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, W_LTE],

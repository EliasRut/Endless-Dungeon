...
const EMPTY = getTileIndex(0, 32);

// Borders
const B_LFT = getTileIndex(4, 0);
const B_RGT = getTileIndex(4, 2);
const B_TOP = getTileIndex(5, 1);
const B_BOT = getTileIndex(3, 1);

// Inner corners
const IC_TL = getTileIndex(5, 0);
const IC_TR = getTileIndex(5, 2);
const IC_BL = getTileIndex(3, 0);
const IC_BR = getTileIndex(3, 2);

// Outer corners
const OC_TL = getTileIndex(3, 4);
const OC_TR = getTileIndex(3, 5);
const OC_BL = getTileIndex(4, 4);
const OC_BR = getTileIndex(4, 5);

// tslint:disable: no-magic-numbers
const CAP_NORTH = [
	[IC_TL, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, IC_TR],
	[B_LFT, 1, 8, 2, 2, 8, 3, B_RGT],
	[B_LFT, 41, 48, 42, 42, 48, 43, B_RGT],
	[B_LFT, EMPTY, 38, EMPTY, EMPTY, 38, EMPTY, B_RGT],
...
const CAP_EAST = [
	...
	[2, 8, 2, 2, 8, 2, 3, B_RGT],
	[42, 48, 42, 42, 48, 42, 43, B_RGT],
	[EMPTY, 38, EMPTY, EMPTY, 38, EMPTY, EMPTY, B_RGT],
...
const CAP_WEST = [
	...
	[B_LFT, 1, 2, 8, 2, 2, 8, 2],
	[B_LFT, 41, 42, 48, 42, 42, 48, 42],
	[B_LFT, EMPTY, EMPTY, 38, EMPTY, EMPTY, 38, EMPTY],
...
const CORRIDOR_LEFT = [
	...
	[EMPTY, EMPTY, 38, EMPTY, EMPTY, 38, EMPTY, EMPTY],
...
const CORRIDOR_UP_RIGHT = [
	[IC_TL, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP, B_TOP],
	[B_LFT, 1, 8, 2, 2, 8, 2, 2],
	[B_LFT, 41, 48, 42, 42, 48, 42, 42],
	[B_LFT, EMPTY, 38, EMPTY, EMPTY, 38, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 120],
];
const CORRIDOR_UP_LEFT = [
	...
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[122, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
];
const CORRIDOR_DOWN_RIGHT = [
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 200],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 1],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 41],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[B_LFT, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
...
const CORRIDOR_DOWN_LEFT = [
	[202, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[3, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[43, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, B_RGT],
...
const T_CROSSING_TOP_LEFT_RIGHT = [
	[202, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 200],
	[3, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 1],
	[43, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 41],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
...
const T_CROSSING_LEFT_RIGHT_BOTTOM = [
	...
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
	[122, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 120],
];
const CROSSWAY = [
	[202, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 200],
	[3, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, 1],

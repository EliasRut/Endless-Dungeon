...
export default class FollowerToken extends NpcToken {
	...
	constructor(
		...
		this.stateObject.faction = Faction.PLAYER;
	...
	// The follower should stay near the player and if it moves out of range, it should move close
	// to the player.

...
export default class SaveIcon extends Phaser.GameObjects.Text {
	constructor(scene: MainScene) {
		super(scene, scene.cameras.main.width - 50, 83, 'Save', { color: 'white', fontSize: '14px' });
		...
		this.on('pointerdown', () => {
			...
			scene.overlayScreens.saveScreen.save();
		});
